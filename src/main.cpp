...
uint8_t face_eye_y = 90, face_eye_x = 80, face_eye_r = 10;
...
uint8_t face_mouth_x = 120, face_mouth_y = 40, face_mouth_width = 50, face_mouth_height = 7, face_mouth_open_width = 30;
...
uint8_t face_angry_x = 210, face_angry_y = 110, face_angry_width = 10, face_angry_length = 2, face_angry_gap = 10;
...
//  M5.Display.setCursor(24, 20); M5.Display.print(str);
  M5.Display.setCursor(20, face_wh - 20); M5.Display.print(str);
	_lipsync();
	tm_speak = 0;
